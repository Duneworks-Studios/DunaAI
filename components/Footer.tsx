      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <Link
              href="/terms"
              className="transition-colors text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
            >
              Terms of Service
            </Link>
            <Link
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 transition-colors group text-[var(--text-secondary)] hover:text-[var(--text-primary)]"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
        ...
        <div className="border-t border-[var(--border-primary)] pt-8 text-center">
