      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          >
            ...
            <motion.a
              href={process.env.NEXT_PUBLIC_WHOP_CHECKOUT_MONTHLY || '#pricing'}
              className="px-8 py-4 premium-border text-dune-gold font-semibold rounded-lg glow-gold-hover transition-all duration-300 hover:scale-105 relative overflow-hidden group"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
